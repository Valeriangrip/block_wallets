...
def get_finder(w3,address):
    ether = get_balance(w3,address)
...
st.sidebar.markdown("# Automating Ethereum with Streamlit!")
...
st.sidebar.write(get_balance(w3,eth_account))
